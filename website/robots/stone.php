...
<head>
    ...
    <meta name="keyword" content="HandsFree hands-free 机器人　底盘　ROS OpenRe Stone">
...
<?php
define('GIRAFFE_INTRODUCTION','../configure/robots/stone/stone.json') ;
$robot_name="";
    ...
    <div class="row buy-join">
        <div class="col-md-6">
            <a class="col-md-12 text-center center-block"
               target="_blank"
               href="https://item.taobao.com/item.htm?spm=2013.1.w4023-13224047678.4.AJC5Df&id=531487775516">
                <h3>购买Stone</h3>
                <h4>获得一款稳定的实验平台</h4>
            </a>
        </div>
