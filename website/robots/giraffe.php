...
<head>
    ...
    <meta name="keyword" content="HandsFree hands-free 机器人　底盘　ROS OpenRe giraffe">
...
<?php
define('GIRAFFE_INTRODUCTION','../configure/robots/giraffe/giraffe.json') ;
$robot_name="";
...
<div class="content">
    ...
    <div class="row introduction-machine">
        <h3 class="col-md-12">
            About
            <?php
            echo "$robot_name" ;
...
<div class="row buy-join">
    <div class="col-md-6">
        <a class="col-md-12 text-center center-block"
           target="_blank"
           href="https://item.taobao.com/item.htm?spm=a1z10.1-c.w4004-13256568658.4.SugnTU&id=531487775516'">
            <h3>购买HandsFree</h3>
            <h4>获得一款稳定的实验平台</h4>
        </a>
    </div>
